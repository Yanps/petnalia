...
const NAV = [
  ...
  { href: '/vet/consultas', icon: 'calendar' as const, label: 'Consultas' },
  { href: '/vet/disponibilidade', icon: 'clock' as const, label: 'Disponibilidade' },
  { href: '/vet/perfil', icon: 'user' as const, label: 'Meu perfil' },
  { href: '/vet/assinatura', icon: 'star' as const, label: 'Assinatura' },
] as const;

export function VetShell({ session, children }: VetShellProps) {
